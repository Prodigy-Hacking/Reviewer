...
exports.run = (bot, member) => {
  ...
  let startReviewEmbed = new Discord.MessageEmbed()
    ...
    .setTitle("REVIEWING...")
    .setDescription(
      `Come back to this DM and type ${prefix}finish when you are done carefully reading the rules!`
    )
  ...
  let errorEmbed = new Discord.MessageEmbed()
    ...
    .setTitle("FAILED")
    .setDescription(
      `Please read all of our rules very carefully, then come back and type ${prefix}finish.`
    )
  ...
  let successEmbed = new Discord.MessageEmbed()
    ...
    .setTitle("SUCCESS")
    .setDescription(
      "Thank you for reading all of our rules, you will now have access to our server.\nRemember to abide by these rules or your account may be punished."
    )
      ...
      member.user.dmChannel
        ...
        .then((collected) => {
          collected.forEach((msg) => {
            Date.now() - startTime > 60000 * mintime &&
            msg.content.startsWith(`${prefix}finish`)
              ? validate(member)
